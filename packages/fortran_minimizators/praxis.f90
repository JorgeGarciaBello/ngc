...
subroutine minfit_p ( n, tol, a, q )

!*****************************************************************************80
!
!! MINFIT_p computes the singular value decomposition of an N by N array.
!
!  Discussion:
!
!    This is an improved version of the EISPACK routine MINFIT_p
...
function praxis ( t0, h0, n, prin, x, f, myp, mdim )
...
!    call to the routine r8mat_print_p (), 22 March 2012.
!
...
!    norm ( x - x0 ) < T0 + sqrtfpprax ( EPSILON ( X ) ) * norm ( X ),
...
!
    ...
    call minny ( n, jsearch, nits, d2, s, value, fk, f, x, t, &
      h, v, q0, q1, nl, nf, dmin, ldt, fx, qa, qb, qc, qd0, qd1, myp, mdim )
...
!
      ...
      if ( k == 2 .and. 1 < prin ) then
        call r8vec_print_p ( n, d, '  The second difference array:' )
      end if
!
...
!
    ...
    if ( 3 < prin ) then
      call r8mat_print_p ( n, n, v, '  The new direction vectors:' )
    end if
...
!  the main loop.
!
!  Transpose V for MINFIT_p:
!
    v(1:n,1:n) = transpose ( v(1:n,1:n) )
!
!  Call MINFIT_p to find the singular value decomposition of V.
!
!  This gives the principal values and principal directions of the
!  approximating quadratic form without squaring the condition number.
!
    call minfit_p ( n, vsmall, v, d )
!
!  Unscale the axes.
!
    if ( 1.0D+00 < scbd ) then
...
!
    ...
    if ( 1 < prin ) then
      ...
      if ( 1.0D+00 < scbd ) then
        call r8vec_print_p ( n, z, '  The scale factors:' )
      end if 

      call r8vec_print_p ( n, d, '  Principal values of the quadratic form:' )

    end if

    if ( 3 < prin ) then
      call r8mat_print_p ( n, n, v, '  The principal axes:' )
    end if
!
...
subroutine r8mat_print_p ( m, n, a, title )

!*****************************************************************************80
!
!! R8MAT_PRINT_p prints an R8MAT.
!
!  Discussion:
!
...
!
  ...
  call r8mat_print_p_some ( m, n, a, 1, 1, m, n, title )

  return
end
subroutine r8mat_print_p_some ( m, n, a, ilo, jlo, ihi, jhi, title )

!*****************************************************************************80
!
!! R8MAT_PRINT_p_SOME prints some of an R8MAT.
!
!  Discussion:
!
!    An R8MAT is an array of R8 values.
...
subroutine r8vec_print_p ( n, a, title )

!*****************************************************************************80
!
!! R8VEC_PRINT_p prints an R8VEC.
!
!  Discussion:
!
...
subroutine timestamp_p ( )

!*****************************************************************************80
!
!! TIMESTAMP_p prints the current YMDHMS date as a time stamp.
!
!  Example:
!
