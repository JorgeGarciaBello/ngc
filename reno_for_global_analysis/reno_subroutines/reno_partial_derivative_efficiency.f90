function reno_partial_derivative_efficiency(b_d,fr,eps,eta)
    use  types
    use reno_data, only: NBIN,ADS,RCTS,nearObs,farObs,bkg,sigma_detection_efficiency,data
    implicit none
    real(dp) :: reno_partial_derivative_efficiency
    ...
    reno_partial_derivative_efficiency= eps/(sigma_detection_efficiency/100.0d0)**2
    result=0.0_dp
    do i=1,NBIN
      N_near=0.0d0;
      N_far=0.0d0;
    ...
    enddo
    reno_partial_derivative_efficiency=2.0_dp*(reno_partial_derivative_efficiency + result)
end function reno_partial_derivative_efficiency