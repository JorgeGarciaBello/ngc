program main_grid
    ...
    real*8 chi_dayabay, chi_reno, chi_doubleCHOOZ, chi_min_global,db_chi_min
...
!            chi2_grid(i,j,k) =chi_reno
 ...
 open(newunit=u,file='g.th23th13dm.'//names)
  ...
  write(u, '(4F16.8)') var_dm23(i),var_th13(j),chi2_grid(i,j,1)
