function db_expected_far_events_from_near_H1_data_P2(bin,t13,dmee,x)
    ...
    enddo
    !db_expected_far_events_from_near_H1_data_P2 = 0.98*(1.0_dp+X(7))*(r3/r1) - x(4)
    db_expected_far_events_from_near_H1_data_P2 = 0.98*(r3/r1) - x(4)    
    return
