function db_expected_far_events_from_near_H1_data_P2(bin,t13,dmee,x)
    ...
    enddo    
    !db_expected_far_events_from_near_H1_data_P2 = 0.9805*(1.0_dp+X(4))*(r3/r1) - Bkg_H3_8AD(bin)*x(3)
    db_expected_far_events_from_near_H1_data_P2 = 0.985*(1.0_dp+X(4))*(r3/r1) - Bkg_H3_8AD(bin)*x(3)
    return
