function reno_far_integral_per_reactor_bin(r,bin,t13,dmee)
    use types
    use reno_data, only: NBIN, bines, length_d_r, neutrino_energy
    implicit none
    ...
    enddo    
    reno_far_integral_per_reactor_bin = result/((b-a)*length_d_r(d,r)**2)
    return
end function reno_far_integral_per_reactor_bin